              ...
              builder: (context, child) {
                return RefreshConfiguration(
                  headerBuilder: () => ClassicHeader(
                    ...
                    refreshingText: LocaleKeys
                        .refreshConfiguration_header_refreshingText.tr,
                    failedText:
                        LocaleKeys.refreshConfiguration_header_failedText.tr,
                    idleText:
                        LocaleKeys.refreshConfiguration_header_idleText.tr,
                  ),
                  footerBuilder: () => ClassicFooter(
                    ...
                    idleText:
                        LocaleKeys.refreshConfiguration_footer_idleText.tr,
                    canLoadingText: LocaleKeys
                        .refreshConfiguration_footer_canLoadingText.tr,
                    noDataText:
                        ...
                        () => MediaQuery(
                          data: AppSettingsService
                              ...
                              : MediaQuery.of(context).copyWith(
                                  textScaleFactor: 1.0), // 字体大小不跟随系统变化
                          child: child!,
                        ),
                      ),
                    ),
